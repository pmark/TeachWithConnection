...
- The previous wrong-logo decision is resolved: `public/images/wc-logo.jpg` now contains the owner-supplied interlocking-rings mark, and the old `logo-small-785x240.jpg` / `logo-large-1570x480.jpg` files are absent.
